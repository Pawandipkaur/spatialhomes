<div class="thrv_wrapper tve-tqb-page-type tqb-result-template-1 tve_editor_main_content" style="<?php echo $main_content_style; ?>">
	...
	<div class="thrv_wrapper thrv_social_custom thrv_social tve-draggable tve-droppable" data-counts="" data-min_shares="0" data-css="tve-u-15d9cfb7ca3">
		<div class="tve_social_items tve_social_custom tve_style_2 tve_social_ib">
			<div class="tve_s_item tve_s_fb_share" data-s="fb_share" data-href="{tcb_post_url}" data-label="Share">
			...
			<div class="tve_s_item tve_s_t_share" data-s="t_share" data-href="{tcb_post_url}" data-label="Tweet">
				<a href="javascript:void(0)" class="tve_s_link">
					<span class="tve_s_icon"></span>
			...
			<div class="tve_s_item tve_s_g_share" data-s="g_share" data-href="{tcb_post_url}" data-label="Share +1">
				<a href="javascript:void(0)" class="tve_s_link">
					<span class="tve_s_icon"></span>
