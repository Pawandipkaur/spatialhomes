...
class TCB_Editor {
	...
	public function main_frame_localize() {
		...
		$data = array(
			...
			'custom_menu'        => array(
				...
				'typography_old_prefix'    => apply_filters( 'tcb_selection_root', '#tve_editor', true ) . ' ',
	...
	public function has_post_breadcrumb_option() {
		return apply_filters( 'tcb_add_post_breadcrumb_option', in_array( get_post_type(), array( 'post', 'page' ) ) );
	}
