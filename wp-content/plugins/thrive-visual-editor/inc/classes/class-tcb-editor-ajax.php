		...
		public function action_global_styles() {
			...
			if ( $is_create ) {
				...
				if ( ! empty( $default_css ) ) {
					$default_css = json_decode( stripslashes( $default_css ), true );

					$global_styles[ $identifier ]['default_css'] = $default_css;
				}
