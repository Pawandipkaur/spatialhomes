...
class TCB_Post_List_Content {
	...
	public static function get_content( $attr ) {
		...
		if ( TCB_Post_List::is_outside_post_list_render() && is_editor_page() ) {
		...
		$classes = 'tcb-post-content ' . TCB_SHORTCODE_CLASS . ( is_editor_page_raw() ? ' tcb-post-content-placeholder' : '' );
