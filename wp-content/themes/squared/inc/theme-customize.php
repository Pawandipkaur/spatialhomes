...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		echo '<style type="text/css">.wp-video-shortcode {max-width: 100% !important;}';
		...
		self::generate_css( '.bSe h1,.bSe h2.entry-title', 'color', 'thrivetheme_headline_color', '' );
		...
		self::generate_css( '.bSe h1,.bSe h2.entry-title', 'font-family', 'thrivetheme_header_font', '' );
		...
		self::generate_css( '.bSe h1,.bSe h2.entry-title', 'text-transform', 'thrivetheme_headline_case', '' );
		self::generate_css( '.cnt article h1', 'font-weight', 'thrivetheme_headline_weight', '' );
		self::generate_css( '.bSe h1,.bSe h2.entry-title', 'font-weight', 'thrivetheme_headline_weight', '' );
		...
		self::generate_css( '.bSe h1,.bSe h2.entry-title, .hru h1, .bSe .entry-title', 'font-size', 'thrivetheme_header_fontsize', '', 'px!important' );
