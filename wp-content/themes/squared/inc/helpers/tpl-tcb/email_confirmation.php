<h1 class="tve_p_center active_delete active_duplicate" contenteditable="true" style="margin-top: 50px;">
...
<p data-default="Enter your text here..." class="tve_p_center" contenteditable="true" style="margin-top: 20px;">To make
...
</div><p data-default="Enter your text here..." class="tve_p_center" contenteditable="true"
